...
select student_id, student_sid, student_name, student_surname,
...
insert into students_has_streets (student_id, street_id)
select student_id, street_id from z_students_denormalized;

insert into students_has_states (student_id, state_id)
select student_id, state_id from z_students_denormalized;

insert into students_has_cities (student_id, city_id)
select student_id, city_id from z_students_denormalized;

insert into students_has_schools (student_id, school_id)
select student_id, school_id from z_students_denormalized;

insert into students_has_clubs (student_id, club_id)
select student_id, club_id from z_students_denormalized;

insert into students_has_projects (student_id, project_id)
select student_id, project_id from z_students_denormalized;

insert into students_has_classes (student_id, class_id)
